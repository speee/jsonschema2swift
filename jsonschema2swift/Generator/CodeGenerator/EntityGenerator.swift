...
class EntityGenerator {
  ...
  func entityName(_ name: String) -> String {
    return fixEntitySuffix(code: "\(name.snake2Camel)Entity")
  }

  var topDocComment: String {
    get {
      return "/// \(entityName(name)).swift" ++
  ...
  var declareCode: String {
    get {
      return declareCodeDoc ++
             "public struct \(entityName(name)): \(singleEntityType) {"
    }
  }
